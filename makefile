...
#===========================================
EFI_FLAGS = -target x86_64-unknown-windows -ffreestanding -fno-stack-protector -fshort-wchar -mno-red-zone -nostdlib -Isrc -Wl,/subsystem:efi_application -Wl,/entry:efi_main
...
all:
	...
	ld.lld $(LD_FLAGS) build/*.o -o kernel.bin
