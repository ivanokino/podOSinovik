...
static const unsigned char font[96][8] = {
    ...
    // 2 (50)
    {0x00, 0x3C, 0x42, 0x04, 0x08, 0x10, 0x7E, 0x00},
    // 3 (51)
    ...
    // 6 (54)
    {0x00, 0x1C, 0x20, 0x40, 0x7C, 0x42, 0x3C, 0x00},
    // 7 (55)
    {0x00, 0x7E, 0x02, 0x04, 0x08, 0x10, 0x20, 0x00},
    // 8 (56)
    {0x00, 0x3C, 0x42, 0x3C, 0x42, 0x42, 0x3C, 0x00},
    // 9 (57)
    {0x00, 0x3C, 0x42, 0x3E, 0x02, 0x04, 0x38, 0x00},
    // : (58)
    ...
    // @ (64)
    {0x00, 0x3C, 0x42, 0x4A, 0x56, 0x40, 0x3C, 0x00},
    // A (65)
    ...
    // Q (81)
    {0x00, 0x3C, 0x42, 0x42, 0x42, 0x44, 0x3A, 0x00},
    // R (82)
    ...
    // Y (89)
    {0x00, 0x42, 0x24, 0x18, 0x10, 0x10, 0x10, 0x00},
    // Z (90)
    ...
    // j (106)
    {0x00, 0x08, 0x00, 0x18, 0x08, 0x08, 0x48, 0x30},
    // k (107)
    {0x00, 0x40, 0x40, 0x44, 0x78, 0x44, 0x42, 0x00},
    // l (108)
    {0x00, 0x30, 0x10, 0x10, 0x10, 0x10, 0x38, 0x00},
    // m (109)
    {0x00, 0x00, 0x6C, 0x52, 0x52, 0x52, 0x42, 0x00},
    // n (110)
    ...
    // t (116)
    {0x00, 0x20, 0x20, 0x7C, 0x20, 0x20, 0x1C, 0x00},
    // u (117)
    {0x00, 0x00, 0x42, 0x42, 0x42, 0x42, 0x3E, 0x00},
    // v (118)
    {0x00, 0x00, 0x42, 0x42, 0x42, 0x24, 0x18, 0x00},
    // w (119)
    {0x00, 0x00, 0x42, 0x42, 0x52, 0x6C, 0x44, 0x00},
    // x (120)
